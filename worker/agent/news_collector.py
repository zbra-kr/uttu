...
신뢰 출처 기준 (아래 도메인 또는 이에 준하는 공신력 있는 매체만 수집):
한국경제·조선일보·중앙일보·동아일보·매일경제·서울경제·머니투데이·헤럴드경제·이데일리·뉴스1·뉴시스·연합뉴스·YTN·MBC·KBS·SBS·한겨레·경향신문 / 패션비즈·어패럴뉴스·패션인사이트·한국섬유신문·텍스헤럴드 / 뉴스와이어·PRNewswire 공식 보도자료 / DART·금융감독원·한국거래소 공시

출처 제외 기준 (하나라도 해당하면 수집 금지):
- 알 수 없는 도메인 (뉴스 매체로 인식되지 않는 사이트)
- 개인 블로그·카페·커뮤니티·SNS 게시물
- 낚시성 제목 또는 내용 확인 불가 단신
- 선정 보고서·랭킹 발표 주체가 불명확한 기사
- 동일 내용을 여러 사이트에 복사한 어뷰징 기사
