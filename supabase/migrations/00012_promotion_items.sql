...
CREATE TABLE promotion_items (
  ...
  limited_total     INTEGER,                            -- limitedOffer.totalCount (선착순만)
  limited_remaining INTEGER,                            -- limitedOffer.remainingCount (선착순만)
  limited_status    TEXT,                               -- PROGRESS / SOLD_OUT (선착순만)
